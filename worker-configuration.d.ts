/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 826046e50bc1bf9ca7e522de349190ee)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	CryptoRiskAgent: DurableObjectNamespace<import("./src/server").CryptoRiskAgent>;
	RISK_WORKFLOW: Workflow<Parameters<import("./src/server").CryptoRiskWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CryptoRiskAgent";
	}
